...
import 'package:bookabite/customerScreens/AuthScreens/signUP.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  Future<DocumentSnapshot> _fetchUser() {
    ...
    return firestore.collection('Users').doc(emailController.text).get();
  }
                  ...
                  WelcomeButton(
                    ...
                    onPressed: () {
                      _auth
                        ...
                        final email = prefsC.getString('email') ?? '';
                        await prefsW.setString('role', 'user');
                        ...
                        if (doc.exists) {
                          ...
                          await prefsC.setString('name', name);
                          await prefsC.setString('phone', phone);
                          await prefsC.setString('city', city);
                          await prefsC.setString('imageUrl', imageUrl);
                          await prefsC.setString('email', email);

                          Variables.nameUser = name;
                          Variables.phoneUser = phone;
                          Variables.cityUser = city;
                          Variables.urlimage = imageUrl;
                          Variables.emailUser = email;
                        }
